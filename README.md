...
> You also can access the documentation in your local machine by running the app (see [Getting Started](#getting-started)) and open http://localhost:8300 in your browser.

## Live Demo

You can try the API by replacing the http://localhost:8300 with the endpoint provided in this repository description.
