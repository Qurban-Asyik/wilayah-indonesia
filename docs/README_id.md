...
> Anda juga dapat mengakses dokumentasinya di perangkat lokal Anda dengan menjalankan aplikasi ini (lihat [Memulai](#memulai)) dan buka http://localhost:8300 di browser Anda.

## Demo

Anda dapat mencoba API ini dengan mengganti http://localhost:8300 dengan endpoint yang disediakan dalam deskripsi repositori ini.
